...
import com.koko.www.androiddemo.utils.ioThread

/**
 * Schema export directory is not provided to the annotation processor so we cannot export the schema
 */
@Database(exportSchema = false,entities = [Cheese::class], version = 1)
abstract class CheeseDb : RoomDatabase() {
    ...
    companion object {
        ...
        @Synchronized
        fun getCheeseDb(context: Context): CheeseDb {
            if (instance == null) {
        ...
        private fun fillInDb(context: Context) {
            ...
            ioThread {
                getCheeseDb(context).cheeseDao().insert(
