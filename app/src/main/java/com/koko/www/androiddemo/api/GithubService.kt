...
interface GithubService {
    ...
    //search/repositories?sort=stars&q=String&page=Int&per_page=Int
...
fun searchRepos(
    ...
    /**
     *  构建的请求链接
     *  https://api.github.com/search/repositories?sort=stars&q=glidein:name,description&page=1&per_page=50
     */
