...
import com.ak47.www.koko_androiddemo.net.json.Earthquake;
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject baseJsonRespones = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray earthquakeArray = baseJsonRespones.getJSONArray("features");
